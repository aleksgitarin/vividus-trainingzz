...
When I wait until element located by `id(item_<itemPageId>_title_link)` appears 
When I click on element located by `id(item_<itemPageId>_title_link)`
...
Then `${element-text(className(shopping_cart_badge))}` is equal to `3`
When I take screenshot
